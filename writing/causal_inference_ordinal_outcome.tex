...
The remainder of this section develops the proposed estimator. I first introduce the latent-index representation used throughout the paper and then describe how conditional normalizing flows are incorporated into a unified likelihood-based estimation framework.
